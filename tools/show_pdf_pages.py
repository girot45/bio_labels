...
from tools import pdf_to_pages
from tools import html_to_pdf
...
class ImageViewerDialog(QDialog):
    def __init__(self, folder_path):
        ...
        self.print_button.clicked.connect(self.show_next_image)
...
def run(new_line):
    ...
    pdf_to_pages.save_pdf_images(SETTINGS.PDF_NAME, SETTINGS.PAGE_DIR)
    dialog = ImageViewerDialog(SETTINGS.PAGE_DIR)
    dialog.exec()
